...
> [!TIP]
> **Looking to build it?** Check out our [Assembly Guide](https://github.com/gerard-hm/SteadyHandTool/blob/main/docs/assembly-guide.md) for step-by-step instructions.
